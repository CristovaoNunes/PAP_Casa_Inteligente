...
void BtnWC01unico() {
  ...
  if (ReleLuzWC01Value == HIGH && ReleVentWC01Value == HIGH) {
    ...
    if (ReleLuzWC01Value == LOW && VentDelayMode == true) {
      DesligarReleVentWC01();
      VentDelayMode = false;
    } else {
...
void BtnWC01LP() {
  ...
  if (ReleLuzWC01Value == HIGH && ReleVentWC01Value == HIGH) {
    DesligarReleLuzWC01();
    client.publish("/Casa/ReleVentWC01/delay", "ON");
    VentDelayMode = true;
  }
}
...
void BtnQuarto01LP() {
  ...
  if (ReleLuzQuarto01Value == LOW) {
    LigarReleLuzQuarto01();
    client.publish("/Casa/ReleLuzQuarto01/delay", "ON");
  } else {
    if (ReleLuzQuarto01Value == HIGH) {
      client.publish("/Casa/ReleLuzQuarto01/delay", "ON");
    }
  }
}
...
void BtnSala01LP() {
  ...
  if (ReleLuzSala01Value == LOW) {
    LigarReleLuzSala01();
    client.publish("/Casa/ReleLuzSala01/delay", "ON");
  } else {
    if (ReleLuzSala01Value == HIGH) {
      client.publish("/Casa/ReleLuzSala01/delay", "ON");
    }
  }
}
...
void BtnSala02LP() {
  ...
  if (ReleLuzSala02Value == LOW) {
    LigarReleLuzSala02();
    client.publish("/Casa/ReleLuzSala02/delay", "ON");
  } else {
    if (ReleLuzSala02Value == HIGH) {
      client.publish("/Casa/ReleLuzSala02/delay", "ON");
    }
  }
}
